...
**transcludes** what a working file already says or **points** to it with a `[[wikilink]]`
— it never summarises, so it cannot put words in the person's mouth (the working
