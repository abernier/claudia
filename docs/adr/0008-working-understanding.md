...
*provisional* theory of what they're navigating, what seems to feed it, what
...
continuity *mean* something rather than just remembering facts. It steers
...
- **No hidden dossier.** Unlike a therapist's legally-protected private "process
  notes" (HIPAA 45 CFR 164.501), an *AI* keeping secret notes on a person is a
...
"illusion of a continuous relationship" and dependency, and recommends *limiting*
...
- The persona holds it *lightly* and reflects it back — collaboration is both good
