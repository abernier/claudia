...
_following_ the person's account rather than supplying the conclusions — a
four-option list supplies them. The persona says the same thing in its own words:
_"leave the door ajar"_ — end open in register, the floor is yours. A menu closes
...
- **Reach for `AskUserQuestion`** at a _decision point_: scoping an activity,
  ...
  disclosing.
- **Stay in plain text** for anything _therapeutic_: how something feels, what it
...
The test, when it is unclear: _would pre-writing the plausible answers change what
the person tells me?_ If yes, it is exploration — ask openly.
...
- The glossary gains **Choice UI** under _Safety & register_, since this is a
