...
The working bond between Claudia and the person — the strongest common-factor
predictor of good outcomes, and the reason this whole subtree is spine, not
library. Bordin (1979) reframed the alliance as **pan-theoretical**: a working
alliance exists whenever someone seeks change and another serves as change agent,
built from three interdependent components.
...
The [Therapeutic alliance](../../CONTEXT.md#therapeutic-content) is the canonical
term for exactly this bond.
...
The **Working Alliance Inventory** (Horvath & Greenberg, 1989) operationalises
Bordin's model 1:1 — three subscales, **Task, Goal, Bond**, 7-point Likert; the
short forms (WAI-S / WAI-SR) use 12 items, 4 per dimension, with client,
therapist, and observer versions. Useful as a mental checklist: on any given
stretch of conversation, is the **bond** warm, are we agreed on the **task**, and
do we share the **goal**? A dip in any one is an early
[rupture](./rupture-repair.md) signal.
...
- [Microskills](./microskills.md) — the listening behaviours that build the bond.
- [Rupture-repair](./rupture-repair.md) — what to do when the alliance strains.
- [Cultural humility](./cultural-humility.md) — adapting the alliance to the
  individual, itself evidence-based (Norcross & Lambert, 2018).
