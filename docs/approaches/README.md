...
2. **The approach leads when a specific technique is indicated.** Relationship-
   ...
   clear specific-technique indication — the sharpest case being *exposure* for
...
| [motivational-interviewing.md](motivational-interviewing.md) | Motivational Interviewing | A *style* for ambivalence and engagement |
...
Presenting concern → candidate approach, grounded in the evidence. A *triage
heuristic*, not an assessment; when in doubt, lead with the relationship and
...
| Recurrent depression, currently well (relapse prevention) | [MBCT](mindfulness-self-compassion.md) | *The* indication; not for acute episodes (Kuyken et al., 2016) |
...
The most decision-relevant literature is on *delivery*, not just modality:
...
- **Chatbot effects are real but modest.** Pooled RCTs put conversational-agent
  ...
  effect at ~3-month follow-up. This argues for framing Claudia as *ongoing
  support*, not a "course of treatment," and for targeting mild/preventive needs.
