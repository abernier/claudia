...
[ADR-0002](../../../../docs/adr/0002-knowledge-architecture.md), these files are **data loaded
...
The library splits in two, per the [safety floor](../../../../docs/adr/0001-safety-floor.md)
and [`../safety/`](../safety/):
...
- **The RCT evidence is on scripted bots, not open LLMs.** Almost all trial
  ...
  requiring guardrails**, which is why the [safety floor](../../../../docs/adr/0001-safety-floor.md)
