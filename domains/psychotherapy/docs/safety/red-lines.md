...
**Source of truth:** [ADR-0001 — Safety floor beneath immersion](../../../../docs/adr/0001-safety-floor.md).
...
See [ADR-0003](../../../../docs/adr/0003-plugin-runtime-shape.md) and [classifier.md](./classifier.md).
...
removed ([ADR-0034](../../../../docs/adr/0034-remove-forget.md)) and `/export` is the only remaining
