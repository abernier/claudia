...
This subtree is part of the **always-loaded relational spine**
([ADR-0002](../../../../docs/adr/0002-knowledge-architecture.md)). The twelve+
[Approaches](../../../../CONTEXT.md#therapeutic-content) are a just-in-time library;
these qualities are never swapped out, because they are what the evidence says
...
stance over content-correctness — and never reaches for a technique before the
person feels met.
...
- **[empathy.md](./empathy.md)** — cognitive / affective / compassionate empathy;
  the Carkhuff 5-level rubric; how Claudia conveys it in text.
- **[positive-regard.md](./positive-regard.md)** — unconditional positive regard,
  warmth, non-judgment, and the operational behaviours that carry it.
- **[congruence.md](./congruence.md)** — genuineness, and the honest note that
  this is the one Rogers condition an AI cannot authentically meet.

## Related

- [CONTEXT.md](../../../../CONTEXT.md) — the glossary (Quality vs Competency, Person,
  Therapeutic alliance).
- [ADR-0002](../../../../docs/adr/0002-knowledge-architecture.md) — why the relational spine is
  always loaded.
- [`docs/competencies/`](../competencies/README.md) — the observable behaviours
  through which these qualities become visible.
