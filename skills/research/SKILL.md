...
Sometimes accuracy serves the person better than a confident guess. When that's
true, look it up — briefly.
...
- **Filter through the safety floor.** Never surface means/methods; never let a
  ...
  refer-only situation, hand toward a qualified human.
